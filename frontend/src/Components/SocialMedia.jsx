...
const SocialMedia = () => {
  return (
    <>
      <div className=" mt-5 ml-15 w-3/5 p-4 flex items-center justify-around text-white text-2xl rounded-xl border border-white/25 bg-gradient-to-r from-white/10 via-white/5 to-transparent shadow-xl backdrop-blur-sm transition-transform duration-300 hover:shadow-blue-600/40">
        <a
        ...
        <a
          href="https://www.linkedin.com/in/prasanthgadde-fullstack/"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/prasanthg2028?igsh=ZzY4ZnI5MHY0YWV5"
          target="_blank"
          rel="noopener noreferrer"
