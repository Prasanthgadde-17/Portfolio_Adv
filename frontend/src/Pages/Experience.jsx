    ...
    <>
      ...
      <div className=" mt-5 p-2 flex flex-col sm:flex-col md:flex-row gap-5 sm:p-8 items-center sm:w-full md:w-full lg:w-1/3 ">
        {Edu.map((experience, index) => (
          <div
            key={index}
            className="bg-gradient-to-r from-gray-700/50 via-gray-900 to-black p-4 sm:p-6 rounded-xl shadow-lg w-full flex flex-row gap-5 border-b border-gray-600 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-blue-500/50 hover:border-blue-500"
          >
